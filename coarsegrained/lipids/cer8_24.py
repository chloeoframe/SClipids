...
class Cer8_24(mb.Compound):
    def __init__(self):
        """Returns a CG uCER8 with the head-to-tail vector pointing in -z.
        """
        super(Cer8_24, self).__init__()
        mb.load('cer8-24.hoomdxml', compound=self, relative_to_module=self.__module__)
