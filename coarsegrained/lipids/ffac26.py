...
class FFAC26(mb.Compound):
    def __init__(self):
        """Returns a CG FFA C27 with the head-to-tail vector pointing in -z.
        """
        super(FFAC26, self).__init__()
        mb.load('ffac26.hoomdxml', compound=self, relative_to_module=self.__module__)
        ...
        self.masses = [0.208819, 0.584458, 0.584458, 0.584458, 0.584458, 0.584458, 0.584458,
